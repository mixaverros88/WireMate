            ...
            >
              ...
              <div class="flex items-center gap-2 mt-3 pt-3 border-t"
                ...
                <button
                  ...
                  :title="hasOtherProjects ? 'Move this mock to another project' : 'No other projects exist — create another project first to enable Move.'"
                  :aria-label="hasOtherProjects ? `Move mock '${mock.name}'` : `Move disabled: no other projects exist`"
